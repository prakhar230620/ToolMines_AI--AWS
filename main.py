...
from routes.all_tool_routes import all_tool_routes
...
app.config['JWT_SECRET'] = '14701c4d1e765347259951b561146a45'
...
all_tool_routes(app,auth_required=auth_required, track_tool_usage=track_tool_usage)
